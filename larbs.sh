...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/xon-dev/voidrice.git" [ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/xon-dev/LARBS/master/progs.csv"
