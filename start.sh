...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n" 10 60
...
additional() {
	...
	sed -i "s/\/home\/xon/\/home\/$(user)/" /usr/share/libalpm/hooks/90-pacwall.hook
}
...
dialog --title "LARBS Installation" --infobox "Preparing install." 5 70
installpkg curl
